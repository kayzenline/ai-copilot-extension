import { AICallOptions, GeminiRequestBody, GeminiResponse } from '../../types/ai';

export function buildGeminiEndpoint(rawEndpoint: string, modelName: string): string {
...
export async function callGeminiAPI(
  ...
  if (!response.ok) {
    ...
    let parsedMessage = '';
    try {
      const errJson: GeminiResponse = JSON.parse(rawError);
